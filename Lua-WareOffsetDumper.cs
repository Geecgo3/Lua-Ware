...
namespace Lua_OffsetDumper // Nothing much offsets update every executor update
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine(@"ooooo                                      oooooo   oooooo     oooo                              
`888'                                       `888.    `888.     .8'                               
 888         oooo  oooo   .oooo.             `888.   .8888.   .8'    .oooo.   oooo d8b  .ooooo.  
 888         `888  `888  `P  )88b             `888  .8'`888. .8'    `P  )88b  `888""""8P d88' `88b 
 888          888   888   .oP""888  8888888     `888.8'  `888.8'      .oP""888   888     888ooo888 
 888       o  888   888  d8(  888               `888'    `888'      d8(  888   888     888    .o 
o888ooooood8  `V88V""V8P' `Y888""""8o               `8'      `8'       `Y888""""8o d888b    `Y8bod8P' 
                                                                                                 ");
            Console.WriteLine("Press any key to load external offsets build | 2/1/2025");
            Console.ReadKey();
            // Last build 2/1/2025
            Console.WriteLine(@"
version-dd2acaf7460f42ee

constexpr std::uint32_t RenderToEngine = 0x10; // DONT USE THIS SHIT AS YOUR SOURCE OF OFFSETS!
...
constexpr std::uint32_t GameLoaded = 0x3d1;
constexpr std::uint32_t LocalPlayer = 0x118;
constexpr std::uint32_t ModelInstance = 0x2a0;
...
constexpr std::uint32_t MeshId = 0x268;
constexpr std::uint32_t TextureId = 0x298;
...
constexpr std::uint32_t ClientDimensions = 0x740;
constexpr std::uint32_t ViewMatrix = 0x4d0;
constexpr std::uint32_t AbsoluteSize = 0x110;
constexpr std::uint32_t Value = 0xc8;
constexpr std::uint32_t TextLabelColor3 = 0xbf0;
constexpr std::uint32_t TextLabelText = 0xb48;
